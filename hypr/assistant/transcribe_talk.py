...
def start_recording() -> None:
    ...
    speak_info("I'm all ears for you darling…")
...
def stop_recording() -> bool:
    ...
    if not text:
        ...
        speak_info(
            "I'm sorry I don't hear you. oh wait did you even said anything or just teasing me you idiot"
        )
